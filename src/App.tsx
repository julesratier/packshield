...
const ScrollToTop = () => {
  ...
  useEffect(() => {
    // Si nous avons un hash dans l'URL (par exemple #faq), nous voulons scroller vers cet élément
    if (hash) {
      // On attend un peu pour s'assurer que le DOM est chargé
      setTimeout(() => {
      ...
      // Sinon, on scrolle vers le haut de la page
      window.scrollTo(0, 0);
    }
  }, [pathname, hash]);
